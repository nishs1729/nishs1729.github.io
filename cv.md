...
_2015 – 2022 | Indian Institute of Science Education and Research, Pune, India_

#### 5-year Integrated MSc in Physics
_2009 – 2014 | Indian Institute of Technology, Kharagpur, India_
{% endcapture %}
...
_2022 – 2025 | Advisor: Prof. Suhita Nadkarni_
...
_PhD Project [2015 – 2022] | Advisor: Prof. Suhita Nadkarni_
...
_Master's Project 2013 – 2014 | Advisor: Prof. Krishna Kumar_
...
* Teaching assistant covering topics on dynamical systems, simulation using Brian2, Python, and MCell for [**Computational Approach to Memory and Plasticity (CAMP) in 2019, 2023, 2024 and 2025**](https://campiiser.com/2023/), a 16-day workshop on Computational Neuroscience organized by Prof. Collins Assisi and Prof. Suhita Nadkarni at IISER Pune.
...
* Taught **simulation using MCell** at the Tata Institute for Fundamental Research, Mumbai, as a teaching assistant for Prof. Suhita Nadkarni.
...
{% endcapture %}
{% include cv_section.html title="Teaching Experience" content=teaching_experience_content %}


{% capture skills_content %}
#### Domain Knowledge
> Mathematics modelling, Nonlinear dynamics, Neuroscience, Probability and stats, reaction network, Spiking neuron model, Monte Carlo 3D simulation, reaction-diffusion systems
...
*   **May 2022:** Awarded EMBO travel grant for attending Dendrites 2022: Dendritic anatomy, molecules and function in Heraklion, Greece
*   **Nov 2016:** Awarded **Infosys Foundation Scholarship** for attending Neuroscience 16, organized by the Society for Neuroscience, San Diego.
*   **2015 – 2020:** Awarded **DST-INSPIRE Fellowship** for PhD.
*   **2009 – 2014:** Awarded **DST-INSPIRE Scholarship** for Integrated MSc.
{% endcapture %}
{% include cv_section.html title="Awards" content=awards_content %}


{% capture volunteering_content %}
*   **Sept 2018:** Lecture demonstrating simulations in Computational Neuroscience for high-school students in the BIS Brain Camp at Sophia College, Mumbai.
*   **2016 – 2017:** Volunteered for Exciting Science Group, an NCL-IISER Pune initiative to **promote scientific methodology in school children**. We conducted science workshops for 8th-grade students in Vasantdada Patil School, Pune, every Saturday for 8 months.
*   **June 2016:** Volunteered for the Gyan-Setu organization to **promote science in rural schools** of Sikkim by demonstrating scientific principles using commonly available objects.
*   **2013 – 2014:** Mentor, Student Mentorship Program, IIT Kharagpur.
{% endcapture %}
